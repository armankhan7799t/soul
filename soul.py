...
def send_welcome(message):
    response = (
        ...
        "💥 /attack - < 𝙄𝙋 > < 𝙋𝙊𝙍𝙏 > 𝙏𝙊 𝙎𝙄𝙈𝙐𝙇𝘼𝙏𝙀 𝘼 𝘿𝘿𝙊𝙎 𝘼𝙏𝙏𝘼𝘾𝙆 (use responsibly! ⚠️)\n"
...
def handle_attack(message):
    ...
    if user_id not in allowed_user_ids:
        ...
        if len(command) == 3 or (not message.text.startswith('/') and len(command) == 2):
            ...
            response = "𝗣𝗟𝗘𝗔𝗦𝗘 𝗣𝗥𝗢𝗩𝗜𝗗𝗘 𝗔𝗧𝗧𝗔𝗖𝗞 𝗗𝗘𝗧𝗔𝗜𝗟𝗦\n\n𝗨𝗦𝗔𝗚𝗘 :- /𝗮𝘁𝘁𝗮𝗰𝗸 < 𝗜𝗣 > < 𝗣𝗢𝗥𝗧 >\n𝗘𝗫𝗔𝗠𝗣𝗟𝗘 :- 👊🤦🙅🔍 𝗠𝗢𝗥𝗘 𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗧𝗜𝗢𝗡:\n- <𝗜𝗣>: 𝗧𝗮𝗿𝗴𝗲𝘁'𝘀 𝗜𝗣 𝗮𝗱𝗱𝗿𝗲𝘀𝘀\n- <𝗣𝗢𝗥𝗧>: 𝗦𝗽𝗲𝗰𝗶𝗳𝗶𝗰 𝗽𝗼𝗿𝘁 𝗳𝗼𝗿 𝘁𝗵𝗲 𝗮𝘁𝘁𝗮𝗰𝗸\n- <𝗧𝗜𝗠𝗘>: 𝗗𝘂𝗿𝗮𝘁𝗶𝗼𝗻 𝗼𝗳 𝘁𝗵𝗲 𝗮𝘁𝘁𝗮𝗰𝗸 𝗶𝗻 𝘀𝗲𝗰𝗼𝗻𝗱𝘀\n\n🚨 𝗨𝗦𝗘 𝗥𝗘𝗦𝗣𝗢𝗡𝗦𝗜𝗕𝗟𝗬 🚨\n\n𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 :- @MR_ARMAN_OWNER"
