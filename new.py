...
TOKEN = "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"  # Ensure to keep your token secure
REPO = "armankhan7799t/soul"
...
def main():
    while True:
        try:
            ...
            updated_content = decoded_content.rstrip() + " "  # Avoid accidental multiple spaces
        ...
        time.sleep(180,000)  # Sleep for 3000 minutes
